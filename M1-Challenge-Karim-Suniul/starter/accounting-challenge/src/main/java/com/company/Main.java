...
public class Main {
    ...
    // inside Main class
    // helper method
    // outside, parse list of strings
    //Iterate through a `List<String[]>` that contains multiple records for each `Customer`,
    // converting it into `List<Customer>` where there is only one copy of each customer (`Integer.parseInt()` converts a `String` to an integer).
    ...
    public static void main(String[] args) {
        //Update this
        // parse the list of strings to customer
        //List<Customer> allCustomers = toCustomerList(customerData);
